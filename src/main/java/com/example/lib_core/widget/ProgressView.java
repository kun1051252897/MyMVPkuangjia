...
public class ProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        @SuppressLint("DrawAllocation") RectF rectF = new RectF((progressViewWidth >> 1) -roundSize/2, (progressViewHeight >> 1) - roundSize/2, (progressViewWidth >> 1) +roundSize/2, (progressViewHeight >> 1) +roundSize/2);
        paint.setColor(arcColor);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(strokeWidth);
        canvas.drawArc(rectF, 180, progressAngle, false, paint);
        String progressText = (progressAngle * 1000) / 360+"";
    ...
    public void setProgress(int progress) {
        ...
        offseAngle = (360*progress)/1000;//扇形总的角度
